    ...
    <Section>
      <Container>
        ...
        <div className="mt-14 grid items-start gap-6 lg:grid-cols-2">
          ...
          <div className="bg-ink-900 text-bone rounded-card shadow-lift p-8">
            <div className="flex items-center gap-3">
              <AlphaDogMark className="text-alpha-500 size-7" />
              <h3 className="text-bone font-display text-sm font-bold tracking-[0.12em] uppercase">
                {comparison.alphadog.label}
              </h3>
            </div>

            <p className="font-display text-alpha-500 mt-5 text-4xl font-extrabold">
            ...
            <ul className="mt-6 space-y-3">
              {comparison.alphadog.included.map((item) => (
                <li key={item} className="flex items-start gap-3">
                  <Check className="text-alpha-500 mt-0.5 size-5 shrink-0" />
